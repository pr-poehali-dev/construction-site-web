...
export default function Footer({ onNavigate }: FooterProps) {
  return (
    <footer style={{ backgroundColor: 'var(--brand-dark)' }} className="text-white">
      <div className="h-0.5 w-full" style={{ backgroundColor: 'var(--brand-blue)' }} />
      <div className="container mx-auto px-6 py-16">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
          <div>
            <button onClick={() => onNavigate('home')} className="flex items-center gap-3 mb-5">
              ...
              >
                <span className="text-white font-display font-bold text-xs">СД</span>
              </div>
              <span className="font-display font-semibold text-base text-white">СтройДом</span>
            </button>
          ...
          <div>
            <h4 className="font-body text-xs tracking-widest uppercase mb-5" style={{ color: 'rgba(255,255,255,0.35)' }}>
              Навигация
            </h4>
        ...
        >
          ...
          <div className="flex items-center gap-2">
            <div className="w-4 h-px" style={{ backgroundColor: 'var(--brand-blue)' }} />
            <span className="text-xs font-body tracking-widest uppercase" style={{ color: 'rgba(255,255,255,0.25)' }}>
              Строим с душой
            </span>
          </div>
        </div>
